...
var routes = [
    {
        path: '',
        component: file_upload_ui_component_1.FileUploadUiComponent,
        data: {
            title: 'File Upload',
            icon: 'ti-layers',
...
exports.FileUploadUiRoutingModule = FileUploadUiRoutingModule;
//# sourceMappingURL=file-upload-ui-routing.module.js.map