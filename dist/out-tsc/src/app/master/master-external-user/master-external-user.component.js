...
var MasterExternalUserComponent = /** @class */ (function () {
    function MasterExternalUserComponent(userService, router, restService) {
    ...
    MasterExternalUserComponent.prototype.onChangeActive = function (check) {
        this.change = check;
        this.enabledUpdated = check;
        console.log(check);
    };
    MasterExternalUserComponent.prototype.onChangeActiveUpdated = function (check) {
        this.enabledUpdated = check;
        console.log(check);
    };
    MasterExternalUserComponent.prototype.ngOnInit = function () {
    };
    MasterExternalUserComponent.prototype.getUser = function () {
        var _this = this;
    ...
    MasterExternalUserComponent.prototype.loadingData = function () {
        var _this = this;
    ...
    MasterExternalUserComponent.prototype.sendUser = function () {
        var _this = this;
        this.submitted = true;
    ...
    MasterExternalUserComponent.prototype.updateUser = function () {
        var _this = this;
        console.log('info');
        console.log(this.myUpdateForm.get('updatename').value, this.myUpdateForm.get('updatelastname').value, this.myUpdateForm.get('updatename').value + ' ' + this.myUpdateForm.get('updatelastname').value, this.myUpdateForm.get('updateusername').value, this.myUpdateForm.get('updatecellphone').value, this.myUpdateForm.get('updatetelephone').value, this.myUpdateForm.get('updateemail').value, this.currentUser.data.id, this.myUpdateForm.get('updateprofile').value);
        ...
        if (!this.myUpdateForm.invalid) {
            ...
            this.userService.updateUser(this.myUpdateForm.get('updatename').value, this.myUpdateForm.get('updatelastname').value, this.myUpdateForm.get('updatename').value + ' ' + this.myUpdateForm.get('updatelastname').value, this.myUpdateForm.get('updateusername').value, this.myUpdateForm.get('updatecellphone').value, this.myUpdateForm.get('updatetelephone').value, this.myUpdateForm.get('updateemail').value, this.currentUser.data.id, this.myUpdateForm.get('updateprofile').value, active).then(function (data) {
                var resp = data;
                console.log(resp);
                if (resp.error) {
                    var msg = '';
    ...
    Object.defineProperty(MasterExternalUserComponent.prototype, "checkForm", {
        get: function () { return this.myForm.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MasterExternalUserComponent.prototype, "checkUpdateForm", {
        get: function () { return this.myUpdateForm.controls; },
        enumerable: true,
        configurable: true
    });
    MasterExternalUserComponent.prototype.saveEmail = function (email) {
        console.log('');
    };
    MasterExternalUserComponent.prototype.handleRefusalToSetEmail = function (dismissMethod) {
        // dismissMethod can be 'cancel', 'overlay', 'close', and 'timer'
        // ... do something
    };
    MasterExternalUserComponent.prototype.openAjaxSwal = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Estás seguro?',
    ...
    MasterExternalUserComponent.prototype.changeCheckUpdate = function (item) {
        console.log(item);
    };
    MasterExternalUserComponent.prototype.deleteUser = function (row) {
        var _this = this;
        sweetalert2_1.default({
    ...
    MasterExternalUserComponent.prototype.showUpdateUser = function (row) {
        console.log(row);
    ...
    MasterExternalUserComponent.prototype.selectOffices = function (event) {
        console.log(event);
        console.log(event);
    ...
    MasterExternalUserComponent.prototype.selectOfficesUpdate = function (event) {
        console.log(event);
        console.log(event);
    ...
    MasterExternalUserComponent.prototype.relationshipUserOffice = function () {
    ...
    MasterExternalUserComponent.prototype.relationshipUserOfficeUpdate = function () {
        console.log(this.selectedBusinessId);
        /*
         this.restService.createRelationshipUserOffices(this.currentUser.data.id,   this.idBranchOffices, this.selectedBusinessId).then(data => {
           const resp: any = data;
    ...
    MasterExternalUserComponent.prototype.getCustomerOffice = function () {
        var _this = this;
        console.log(this.selectedBusinessId);
        this.idBranchOffices = [1];
        this.userOfficeRelationShips = [];
    ...
    MasterExternalUserComponent.prototype.goAdminUsers = function () {
        this.router.navigateByUrl('master/register');
    };
    MasterExternalUserComponent.prototype.updateCustomerOffices = function (customer) {
        var _this = this;
        ...
        sweetalert2_1.default.showLoading();
        this.restService.getRelationshipUserOffices(this.currentUser.data.id).then(function (data) {
            var resp = data;
            if (resp.error) {
                sweetalert2_1.default({
                    title: 'Error',
    ...
    MasterExternalUserComponent.prototype.getRelationshipUserOffices = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Obteniendo información ...',
            allowOutsideClick: false
    ...
    MasterExternalUserComponent.prototype.kilo = function () {
        console.log('kilo');
    };
    MasterExternalUserComponent.prototype.createRelationShip = function () {
    };
    MasterExternalUserComponent.prototype.closeModalRelationship = function () {
        var _this = this;
        ...
        for (var _i = 0, _a = this.clientOfficeRelationShips; _i < _a.length; _i++) {
            ...
            if (branchOfficesNumber.length > 0) {
                this.restService.createRelationshipUserOffices(this.currentUser.data.id, branchOfficesNumber, clientOffice.idClient).then(function (data) {
                    var resp = data;
    ...
    MasterExternalUserComponent.prototype.showClient = function () {
    ...
    MasterExternalUserComponent.prototype.deleteAllOfficesBranchUser = function (idUser, idCustomer, branchOfficesNumbeUpdate) {
        var _this = this;
        this.userService.deleteOfficesBranchUser(idUser, idCustomer).then(function (data) {
            var resp = data;
            if (branchOfficesNumbeUpdate.length > 0) {
                _this.restService.createRelationshipUserOffices(_this.currentUser.data.id, branchOfficesNumbeUpdate, _this.currentCustomerUpdated).then(function (data) {
                    var resp = data;
                    sweetalert2_1.default({
                        title: 'Sedes actualizadas',
                        type: 'success'
    ...
    MasterExternalUserComponent.prototype.deleteCustomerOffices = function (customer) {
        console.log(customer);
    };
    MasterExternalUserComponent = __decorate([
        core_1.Component({
        ...
        __metadata("design:paramtypes", [user_service_1.UserService, router_1.Router, rest_service_1.RestService])
    ], MasterExternalUserComponent);
    return MasterExternalUserComponent;
}());
exports.MasterExternalUserComponent = MasterExternalUserComponent;
//# sourceMappingURL=master-external-user.component.js.map