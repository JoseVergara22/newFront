...
var MasterMultiDatePickerComponent = /** @class */ (function () {
    //  currentDateRoutines: Array <currentDateInterface> = [];
    function MasterMultiDatePickerComponent(calendar, workService) {
        var _this = this;
    ...
    MasterMultiDatePickerComponent.prototype.ngOnInit = function () {
    };
    Object.defineProperty(MasterMultiDatePickerComponent.prototype, "datesSelected", {
        get: function () {
    ...
    Object.defineProperty(MasterMultiDatePickerComponent.prototype, "currentDateRoutines", {
        get: function () {
    ...
    MasterMultiDatePickerComponent.prototype.onDateSelection = function (event, date) {
        console.log(date);
    ...
    MasterMultiDatePickerComponent.prototype.getWorks = function () {
        var _this = this;
    ...
    MasterMultiDatePickerComponent.prototype.getOle = function () {
        return '{year: 2019, month: 10}';
    };
    MasterMultiDatePickerComponent.prototype.addDate = function (date) {
    ...
    MasterMultiDatePickerComponent.prototype.addCancelDate = function () {
        //If exist, remove the date
        this.cleanSelectRoutines();
        document.getElementById('routineButtonCancel').click();
    };
    MasterMultiDatePickerComponent.prototype.cleanSelectRoutines = function () {
    ...
    MasterMultiDatePickerComponent.prototype.SelectItemRoutines = function (idItem) {
        this.routineSelecteds.map(function (dato) {
    ...
    MasterMultiDatePickerComponent.prototype.addDateRoutine = function () {
        var _this = this;
    ...
    MasterMultiDatePickerComponent.prototype.addRangeDate = function (fromDate, toDate) {
    ...
    MasterMultiDatePickerComponent.prototype.isDateSelected = function (date) {
    ...
    ], MasterMultiDatePickerComponent.prototype, "datesSelected", null);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], MasterMultiDatePickerComponent.prototype, "currentDateRoutines", null);
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
    ], MasterMultiDatePickerComponent.prototype, "datesSelectedChange", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
    ], MasterMultiDatePickerComponent.prototype, "currentDateRoutinesChange", void 0);
    MasterMultiDatePickerComponent = __decorate([
        core_1.Component({
    ...
    return MasterMultiDatePickerComponent;
}());
exports.MasterMultiDatePickerComponent = MasterMultiDatePickerComponent;
//# sourceMappingURL=master-multi-date-picker.component.js.map