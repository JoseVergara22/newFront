...
var MasterSettlementCustomerComponent = /** @class */ (function () {
    function MasterSettlementCustomerComponent(restService, router, estimateService, excelService, workService, uploadService, forkliftService, settlementService) {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.removeAccents = function (str) {
        return str.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    };
    MasterSettlementCustomerComponent.prototype.getConsecutive = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.getEstimateDetails = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.getEstimateWorkforce = function () {
        var _this = this;
        if (this.settlementId) {
            this.estimateService.getEstimateDetailsWorkforce(this.settlementId).then(function (data) {
                var resp = data;
    ...
    MasterSettlementCustomerComponent.prototype.getEstimateParts = function () {
        var _this = this;
        if (this.settlementId) {
            this.estimateService.getEstimateDetailsParts(this.settlementId).then(function (data) {
                var resp = data;
    ...
    MasterSettlementCustomerComponent.prototype.getCustomers = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.getCustomerRegionals = function () {
        var _this = this;
        this.restService.getRegionalCustomers(this.selectedRegionalId.id).then(function (data) {
            var resp = data;
            console.log(data);
            sweetalert2_1.default.close();
            _this.customers = resp.data;
    ...
    MasterSettlementCustomerComponent.prototype.getTrmCurrent = function () {
        var _this = this;
        console.log('oleole');
    ...
    MasterSettlementCustomerComponent.prototype.format = function (inputTrm) {
    ...
    MasterSettlementCustomerComponent.prototype.getCities = function () {
        var _this = this;
        console.log('oleole');
    ...
    MasterSettlementCustomerComponent.prototype.getDepartments = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.getForklifs = function () {
        var _this = this;
        if (this.selectedBranchOfficeId != 0) {
            ...
            this.forkliftService.getForkliftBranchOfficesFull(this.selectedBranchOfficeId.id).then(function (data) {
                var resp = data;
                console.log(data);
                sweetalert2_1.default.close();
    ...
    MasterSettlementCustomerComponent.prototype.getBranchOffices = function () {
        var _this = this;
        if (this.selectedBusinessId != 0) {
            ...
            this.getCities();
            this.restService.getOffice(this.selectedBusinessId.id).then(function (data) {
                var resp = data;
    ...
    MasterSettlementCustomerComponent.prototype.getCenterCost = function () {
        var _this = this;
        this.getCustomerRegionals();
        this.getWarehouses();
        //selectedCostCenterId
        this.restService.getCostCenterSettlement(this.selectedRegionalId.id).then(function (data) {
            var resp = data;
            console.log(data);
            sweetalert2_1.default.close();
    ...
    MasterSettlementCustomerComponent.prototype.getWarehouses = function () {
        var _this = this;
        //selectedCostCenterId
        this.restService.getWarehousesSettlement(this.selectedRegionalId.id).then(function (data) {
            var resp = data;
            console.log(data);
            sweetalert2_1.default.close();
    ...
    MasterSettlementCustomerComponent.prototype.loadingData = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.createEstimateDetail = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        ...
        if (Number(priceTemp) >= Number(this.lowPrice) && Number(priceTemp) <= Number(this.higherPrice)) {
            var estimateIdDetailTemp = this.settlementId;
            ...
            this.estimateService.createEstimateDetails(estimateIdDetailTemp, codeTemp, descriptionTemp, quantityTemp, unitCostTemp, priceListTemp, priceSuggestTemp, weightTemp, priceTemp, subtotalTemp, deliveryPartTemp, totalTemp, statusTemp, typeServiceTemp, weightTypeList).then(function (data) {
                var resp = data;
                sweetalert2_1.default({
                    title: 'Item creado',
                    type: 'success'
    ...
    MasterSettlementCustomerComponent.prototype.changeFormatDecimal = function (price) {
        var priceTempStr = price.toString();
        priceTempStr = priceTempStr.split('.').join('');
        var priceTemp = priceTempStr.replace(',', '.');
        return priceTemp;
    };
    MasterSettlementCustomerComponent.prototype.updateEstimateDetail = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        ...
        if (Number(priceUpdateTemp) >= Number(this.lowPriceUpdate) && Number(priceUpdateTemp) <= Number(this.higherPriceUpdate)) {
            ...
            this.estimateService.updateEstimateDetails(estimateIdDetailTemp, codeTemp, descriptionTemp, quantityTemp, unitCostTemp, priceListTemp, priceSuggestTemp, weightTemp, priceUpdateTemp, subtotalTemp, deliveryPartTemp, totalTemp, statusTemp, typeServiceTemp, weightTypeTemp).then(function (data) {
                var resp = data;
                sweetalert2_1.default({
    ...
    // 
    MasterSettlementCustomerComponent.prototype.updateEstimateDetailWorkforce = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
    ...
    MasterSettlementCustomerComponent.prototype.sendPriceCountries = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.ChangingValue = function () {
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        });
    ...
    MasterSettlementCustomerComponent.prototype.sendUpdatePriceCountries = function () {
        var _this = this;
    ...
    Object.defineProperty(MasterSettlementCustomerComponent.prototype, "checkForm", {
        get: function () { return this.myForm.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MasterSettlementCustomerComponent.prototype, "checkFormUpdate", {
        get: function () { return this.myFormUpdate.controls; },
        enumerable: true,
        configurable: true
    });
    MasterSettlementCustomerComponent.prototype.updateItems = function (item) {
        console.log('-----------------------');
        console.log(item);
    ...
    MasterSettlementCustomerComponent.prototype.updateWorkForceItems = function (item) {
    ...
    MasterSettlementCustomerComponent.prototype.deletePriceCountry = function (item) {
        var _this = this;
        sweetalert2_1.default({
    ...
    MasterSettlementCustomerComponent.prototype.deleteEstimateDetail = function (item) {
        var _this = this;
        sweetalert2_1.default({
            title: 'Estás seguro de eliminar este elemento?',
            // text: 'Once deleted, you will not be able to recover this imaginary file!',
    ...
    MasterSettlementCustomerComponent.prototype.calculateFreight = function (weight, price) {
    ...
    MasterSettlementCustomerComponent.prototype.calculateFreightUpdate = function (weight, price) {
    ...
    MasterSettlementCustomerComponent.prototype.ngOnInit = function () {
    };
    MasterSettlementCustomerComponent.prototype.blockAgents = function (vadr) {
        console.log(vadr);
    };
    MasterSettlementCustomerComponent.prototype.showShippingCountriesDhlInitial = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.getConfigTrmInitial = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.getForkliftText = function () {
    ...
    MasterSettlementCustomerComponent.prototype.getConfigEstimatesInitial = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.showShippingCountriesDhl = function (conditionValidation, country, weight, ind) {
    ...
    MasterSettlementCustomerComponent.prototype.showCountryWeight = function (country, weight, ind) {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.calculateFreightValues = function () {
    ...
    MasterSettlementCustomerComponent.prototype.calculateFreightValuesUpdate = function () {
    ...
    MasterSettlementCustomerComponent.prototype.finalOperation = function (country) {
    ...
    MasterSettlementCustomerComponent.prototype.finalOperationUpdate = function (country) {
        //Variables necesarias para  el calculo
        // this.freightGeneral  this.managementVariables this.finalWeight
        console.log('Ingreso hasta aquí');
        var drivingCost = 0;
    ...
    MasterSettlementCustomerComponent.prototype.downloadPdf = function () {
        var doc = new jsPDF();
    ...
    MasterSettlementCustomerComponent.prototype.normalize = function (element) {
    ...
    MasterSettlementCustomerComponent.prototype.onSelectFileImage = function (event) {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.onSelectFile = function (event) {
        var filesAmount = event.target.files.length;
        var filename = event.target.files[event.target.files.length - 1].name;
    ...
    MasterSettlementCustomerComponent.prototype.uploadImagesEstimate = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.uploadAll = function () {
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        });
    ...
    MasterSettlementCustomerComponent.prototype.uploadFiles = function () {
        var _this = this;
        for (var _i = 0, _a = this.selectedFiles; _i < _a.length; _i++) {
            ...
            console.log(extension);
            this.uploadService.uploadFilesAll(file, this.settlementId, 0, nameTemp).then(function (res) {
                console.log('s3info' + JSON.stringify(res));
                _this.s3info = res;
                console.log(_this.s3info);
                /*swal({
    ...
    MasterSettlementCustomerComponent.prototype.uploadFilesImages = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.deleteImage = function (i) {
    ...
    MasterSettlementCustomerComponent.prototype.deleteFile = function (i) {
        if (this.showSaveFile == true) {
    ...
    MasterSettlementCustomerComponent.prototype.dataURItoBlob = function (dataURI) {
    ...
    MasterSettlementCustomerComponent.prototype.downloadEcxel = function () {
        this.excelService.exportAsExcelFile(this.data, 'sample');
    };
    MasterSettlementCustomerComponent.prototype.convertImgToBase64 = function (url) {
    ...
    MasterSettlementCustomerComponent.prototype.getBase64Image = function (img) {
        var canvas = document.createElement("canvas");
        console.log("image");
        canvas.width = img.width;
        canvas.height = img.height;
    ...
    MasterSettlementCustomerComponent.prototype.download = function () {
        var imageurl = 'data:image/png;base64,';
    ...
    MasterSettlementCustomerComponent.prototype.upload = function () {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.upload3 = function (image) {
        var _this = this;
    ...
    MasterSettlementCustomerComponent.prototype.createSettlementCondition = function () {
        // Validar condiciones
    ...
    /* validateEmail( email )
   {
    ...
    MasterSettlementCustomerComponent.prototype.showSettlementProgramming = function () {
        document.getElementById('showModalProgramming').click();
    };
    MasterSettlementCustomerComponent.prototype.showSettlementEstimateBusiness = function () {
        document.getElementById('showModalApproval').click();
    };
    MasterSettlementCustomerComponent.prototype.createSettlement = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        ...
        var branchOfficeTemp = this.selectedBranchOfficeId.id;
        ...
        this.settlementService.createSettlement(consecutiveTemp, customerIdTemp, documentCustomerTemp, idDepartmentTemp, selectedCityTemp, contactTemp, cellphoneTemp, observationTemp, 0, '', 0, selectedRegionalIdTemp, selectedCostCenterIdTemp, selectedWarehouseIdTemp, numberEstimateTemp, branchOfficeTemp, selectedForkliftIdTemp, forkliftTextTemp).then(function (data) {
            var resp = data;
            ...
            _this.settlementService.updateConsecutive().then(function (data) {
                ...
                _this.router.navigateByUrl('maintenance/settlementCustomerUpdate/' + _this.settlementId);
    ...
    MasterSettlementCustomerComponent.prototype.createEstimateDetailWorkforce = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        ...
        sweetalert2_1.default.showLoading();
        var estimateIdTemp = this.settlementId;
    ...
    MasterSettlementCustomerComponent.prototype.sendEmailEstimate = function () {
    ...
    MasterSettlementCustomerComponent.prototype.calculateSubtotalWork = function () {
    ...
    MasterSettlementCustomerComponent.prototype.calculateSubtotalWorkUpdate = function () {
        console.log('calular de subtotal actualizar');
    ...
    MasterSettlementCustomerComponent.prototype.createNewCustomer = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        ...
        sweetalert2_1.default.showLoading();
        var margin = Number(this.newCustomerMargin);
        console.log('Ingreso a crear un nuevo cliente');
        this.restService.createCustomerNewCustomer(this.nameCustomer, 3, this.documentCustomer, this.cellphone, 'Sin Dirección', 0, margin, 1, this.selectedCityId, this.selectedDepartmentId, this.selectedRegionalId.id)
            .then(function (data) {
            var resp = data;
            console.log(resp);
    ...
    MasterSettlementCustomerComponent.prototype.updateNewCustomer = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
    ...
    //  this.selectedBusinessId != 0 &&
    MasterSettlementCustomerComponent.prototype.updateEstimateCondition = function () {
    ...
    MasterSettlementCustomerComponent.prototype.updateEstimate = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        ...
        this.estimateService.updateEstimate(this.settlementId, customerIdTemp, documentCustomerTemp, idDepartmentTemp, selectedCityTemp, selectedForkliftIdTemp, contactTemp, daysTemp, guarantyTemp, validityTemp, cellphoneTemp, observationTemp, forkliftTextTemp, 0).then(function (data) {
            var resp = data;
            _this.settlementId = resp.data.id;
            _this.showSettlementId = false;
            _this.showCreateItem = true;
    ...
    MasterSettlementCustomerComponent.prototype.getBase64Images2 = function (img) {
    ...
    MasterSettlementCustomerComponent.prototype.getBase64ImageFromUrl = function (imageUrl) {
    ...
    MasterSettlementCustomerComponent.prototype.pp = function () {
        this.getBase64ImageFromUrl('https://masterforklift.s3.amazonaws.com/estimate_files/ole.jpeg')
            .then(function (result) { return console.log(result); })
            .catch(function (err) { return console.error(err); });
    };
    MasterSettlementCustomerComponent.prototype.formatValue = function (inputTrm) {
        console.log(inputTrm);
    ...
    MasterSettlementCustomerComponent.prototype.finalFormat = function (num) {
        num += '';
    ...
    MasterSettlementCustomerComponent.prototype.calculateSubtotal = function () {
        var priceTemp = this.changeFormatDecimal(this.price);
    ...
    MasterSettlementCustomerComponent.prototype.calculateSubtotalUpdate = function () {
        var priceUpdateTemp = this.changeFormatDecimal(this.priceUpdate);
        // =this.price.toString().replace('.','').replace(',','.');
    ...
    MasterSettlementCustomerComponent.prototype.finalFormatPrice = function () {
    ...
    MasterSettlementCustomerComponent.prototype.finalFormaHourValue = function () {
    ...
    MasterSettlementCustomerComponent.prototype.finalFormaHourValueUpdate = function () {
    ...
    MasterSettlementCustomerComponent.prototype.finalFormaHourValueSubtotal = function () {
    ...
    MasterSettlementCustomerComponent.prototype.finalFormaHourValueSubtotalUpdate = function () {
    ...
    MasterSettlementCustomerComponent.prototype.finalFormatStandard = function (priceUpdate) {
    ...
    MasterSettlementCustomerComponent.prototype.finalFormatPriceUpdate = function () {
    ...
    MasterSettlementCustomerComponent.prototype.clearFormDetail = function () {
        this.code = '';
        this.description = '';
        this.quantity = 1;
        this.unitCost = 0;
    ...
    MasterSettlementCustomerComponent.prototype.clearFormDetailUpdate = function () {
        this.codeUpdate = '';
        this.descriptionUpdate = '';
        this.quantityUpdate = 1;
        this.unitCostUpdate = 0;
    ...
    MasterSettlementCustomerComponent.prototype.clearFormDetailWork = function () {
        this.workforceCode = '';
        this.workforceService = '';
        this.workforcequantity = 1;
        this.workforceHourValue = 0;
    ...
    MasterSettlementCustomerComponent.prototype.clearFormDetailWorkUpdate = function () {
        this.workforceCode = '';
        this.workforceService = '';
        this.workforcequantity = 1;
        this.workforceHourValue = 0;
    ...
    MasterSettlementCustomerComponent.prototype.cancelFormDetail = function () {
        document.getElementById('createItemHide').click();
        this.clearFormDetail();
    };
    MasterSettlementCustomerComponent.prototype.cancelFormDetailUpdate = function () {
        document.getElementById('updateItemHide').click();
        this.clearFormDetailUpdate();
    };
    MasterSettlementCustomerComponent.prototype.cancelFormWorkCreate = function () {
        document.getElementById('createHideWorkforce').click();
        this.clearFormDetailWork();
    };
    MasterSettlementCustomerComponent.prototype.cancelFormDetailWorkforceUpdate = function () {
    ...
    ], MasterSettlementCustomerComponent.prototype, "content", void 0);
    MasterSettlementCustomerComponent = __decorate([
        core_1.Component({
        ...
        __metadata("design:paramtypes", [rest_service_1.RestService, router_1.Router, estimate_service_1.EstimateService, filexcel_service_1.FilexcelService, work_service_1.WorkService, upload_service_1.UploadService, forklift_service_1.ForkliftService, settlement_service_1.SettlementService])
    ], MasterSettlementCustomerComponent);
    return MasterSettlementCustomerComponent;
}());
exports.MasterSettlementCustomerComponent = MasterSettlementCustomerComponent;
//# sourceMappingURL=master-settlement-customer.component.js.map