...
var MasterCopyEstimateCustomerComponent = /** @class */ (function () {
    function MasterCopyEstimateCustomerComponent(restService, router, estimateService, excelService, workService, uploadService, forkliftService, rutaActiva) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.getConsecutive = function () {
        var _this = this;
    ...
    MasterCopyEstimateCustomerComponent.prototype.getEstimateSpecific = function (id) {
        var _this = this;
        this.estimateService.getEstimateSpecific(id).then(function (data) {
            ...
            _this.email = _this.currentEstimate.email;
    ...
    MasterCopyEstimateCustomerComponent.prototype.getEstimateDetails = function () {
        var _this = this;
        if (this.estimateId) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.getCustomers = function () {
        var _this = this;
        this.restService.getCustomer().then(function (data) {
            ...
            _this.selectedBusinessId = Number(_this.currentEstimate.customer_id);
            _this.getForklifs();
            // this.rowsClient = resp.data;
            // this.rowStatic =  resp.data;
            // this.rowsTemp = resp.data;
    ...
    MasterCopyEstimateCustomerComponent.prototype.getTrmCurrent = function () {
        var _this = this;
        console.log('oleole');
    ...
    MasterCopyEstimateCustomerComponent.prototype.format = function (inputTrm) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.getCities = function () {
        var _this = this;
        console.log('oleole');
        this.restService.getCities(this.currentEstimate.department_id).then(function (data) {
            var resp = data;
            console.log(data);
            sweetalert2_1.default.close();
            _this.cities = resp.data;
            if (_this.currentEstimate.city_id) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.getDepartments = function () {
        var _this = this;
        this.restService.getDepartments().then(function (data) {
            ...
            _this.selectedDepartmentId = Number(_this.currentEstimate.department_id);
            _this.getCities();
        }).catch(function (error) {
            console.log(error);
        });
    };
    MasterCopyEstimateCustomerComponent.prototype.getForklifs = function () {
        var _this = this;
      ...
      */
        if (this.selectedBusinessId != 0) {
            this.forkliftService.getForkliftsCustomerFull(this.selectedBusinessId).then(function (data) {
                ...
                // this.rowsTemp = resp.data;
                // console.log( this.rowsClient);
                _this.selectedForkliftId = _this.currentEstimate.forklift_id;
            }).catch(function (error) {
                console.log(error);
            });
        }
    };
    MasterCopyEstimateCustomerComponent.prototype.loadingData = function () {
        var _this = this;
    ...
    MasterCopyEstimateCustomerComponent.prototype.createEstimateDetail = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        ...
        var priceSuggestTemp = this.suggestedPrice;
        var daysTemp = this.days;
        var priceTemp = this.price;
        var deliveryTemp = this.validity;
        var weightTemp = this.weight;
        var totalTemp = this.subtotal;
        var observationTemp = this.observation;
        var statusTemp = 0;
        var subtotalTemp = this.subtotal;
        var typeServiceTemp = 0;
        this.estimateService.createEstimateDetails(estimateIdDetailTemp, codeTemp, descriptionTemp, quantityTemp, unitCostTemp, priceListTemp, priceSuggestTemp, weightTemp, priceTemp, subtotalTemp, deliveryTemp, totalTemp, statusTemp, typeServiceTemp, 0).then(function (data) {
            var resp = data;
            sweetalert2_1.default({
                title: 'Item creado',
                type: 'success'
    ...
    MasterCopyEstimateCustomerComponent.prototype.sendPriceCountries = function () {
        var _this = this;
    ...
    MasterCopyEstimateCustomerComponent.prototype.ChangingValue = function () {
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        });
    ...
    MasterCopyEstimateCustomerComponent.prototype.sendUpdatePriceCountries = function () {
        var _this = this;
    ...
    Object.defineProperty(MasterCopyEstimateCustomerComponent.prototype, "checkForm", {
        get: function () { return this.myForm.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MasterCopyEstimateCustomerComponent.prototype, "checkFormUpdate", {
        get: function () { return this.myFormUpdate.controls; },
        enumerable: true,
        configurable: true
    });
    MasterCopyEstimateCustomerComponent.prototype.updateItems = function (item) {
        var idDetail = item.estimate_id;
    ...
    MasterCopyEstimateCustomerComponent.prototype.deletePriceCountry = function (country) {
        var _this = this;
        sweetalert2_1.default({
    ...
    MasterCopyEstimateCustomerComponent.prototype.calculateFreight = function (weight, price) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.calculateFreightUpdate = function (weight, price) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.ngOnInit = function () {
    };
    MasterCopyEstimateCustomerComponent.prototype.blockAgents = function (vadr) {
        console.log(vadr);
    };
    MasterCopyEstimateCustomerComponent.prototype.showShippingCountriesDhlInitial = function () {
        var _this = this;
    ...
    MasterCopyEstimateCustomerComponent.prototype.getConfigTrmInitial = function () {
        var _this = this;
        this.estimateService.getConfigTrm().then(function (data) {
            ...
            _this.estimateService.showTrmCurrent().then(function (data) {
                ...
                _this.trmGeneralEsp = (trm * _this.conditionTrmEsp.constant).toFixed(2);
    ...
    MasterCopyEstimateCustomerComponent.prototype.getConfigEstimatesInitial = function () {
        var _this = this;
    ...
    MasterCopyEstimateCustomerComponent.prototype.showShippingCountriesDhl = function (conditionValidation, country, weight) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.showCountryWeight = function (country, weight) {
        var _this = this;
    ...
    MasterCopyEstimateCustomerComponent.prototype.calculateFreightValues = function () {
    ...
    MasterCopyEstimateCustomerComponent.prototype.calculateFreightValuesUpdate = function () {
        console.log('jajajajaj');
    ...
    MasterCopyEstimateCustomerComponent.prototype.finalOperation = function (country) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.downloadPdf = function () {
        var doc = new jsPDF();
    ...
    MasterCopyEstimateCustomerComponent.prototype.dataURItoBlob = function (dataURI) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.downloadEcxel = function () {
        this.excelService.exportAsExcelFile(this.data, 'sample');
    };
    MasterCopyEstimateCustomerComponent.prototype.convertImgToBase64 = function (url) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.getBase64Image = function (img) {
        var canvas = document.createElement("canvas");
        console.log("image");
        canvas.width = img.width;
        canvas.height = img.height;
    ...
    MasterCopyEstimateCustomerComponent.prototype.download = function () {
        var imageurl = 'data:image/png;base64,';
    ...
    MasterCopyEstimateCustomerComponent.prototype.upload = function (idForklift) {
        var _this = this;
        var doc = new jsPDF('portrait', 'px', 'a4');
        doc.autoTable({
            head: [['Name', 'Email', 'Country']],
        ...
        var fileole = doc;
        console.log(fileole);
        var uuid = 'aaaaaaaaaaa123';
        console.log(uuid);
        var extension = 'pdf';
        console.log(extension);
        this.uploadService.uploadFileForkliftUpdate2(this.fileTest).then(function (res) {
    ...
    MasterCopyEstimateCustomerComponent.prototype.createEstimate = function () {
        var _this = this;
        sweetalert2_1.default({
            title: 'Validando información ...',
            allowOutsideClick: false
        ...
        var customerIdTemp = Number(this.selectedBusinessId.id);
        ...
        var observationTemp = this.observation;
        var forkliftTextTemp = 'test';
        console.log();
        this.estimateService.createEstimate(consecutiveTemp, customerIdTemp, documentCustomerTemp, idDepartmentTemp, selectedCityTemp, selectedForkliftIdTemp, contactTemp, daysTemp, guarantyTemp, validityTemp, cellphoneTemp, observationTemp, 0, this.email, 0, forkliftTextTemp, 0).then(function (data) {
            var resp = data;
    ...
    ], MasterCopyEstimateCustomerComponent.prototype, "content", void 0);
    MasterCopyEstimateCustomerComponent = __decorate([
        core_1.Component({
    ...
    return MasterCopyEstimateCustomerComponent;
}());
exports.MasterCopyEstimateCustomerComponent = MasterCopyEstimateCustomerComponent;
//# sourceMappingURL=master-copy-estimate-customer.component.js.map