...
exports.Cmyk = Cmyk;
var MasterForkliftShowComponent = /** @class */ (function (_super) {
    __extends(MasterForkliftShowComponent, _super);
    function MasterForkliftShowComponent(_i18n, restService, router, uploadService, parserFormatter, calendar, cpService, workService, rutaActiva, forkliftService) {
        ...
        var startTime = new forms_1.FormControl('', forms_1.Validators.required);
        var currentTime = new forms_1.FormControl('', forms_1.Validators.required);
    ...
    MasterForkliftShowComponent_1 = MasterForkliftShowComponent;
    MasterForkliftShowComponent.prototype.isWeekend = function (date) {
        var d = new Date(date.year, date.month - 1, date.day);
        return d.getDay() === 0 || d.getDay() === 6;
    };
    MasterForkliftShowComponent.prototype.isDisabled = function (date, current) {
        return date.month !== current.month;
    };
    MasterForkliftShowComponent.prototype.getWeekdayShortName = function (weekday) {
        return I18N_VALUES[this._i18n.language].weekdays[weekday - 1];
    };
    MasterForkliftShowComponent.prototype.getMonthShortName = function (month) {
        return I18N_VALUES[this._i18n.language].months[month - 1];
    };
    MasterForkliftShowComponent.prototype.getMonthFullName = function (month) {
        return this.getMonthShortName(month);
    };
    MasterForkliftShowComponent.prototype.getDayAriaLabel = function (date) {
        return date.day + "-" + date.month + "-" + date.year;
    };
    MasterForkliftShowComponent.prototype.eventClicked = function (event) {
        console.log(event);
    };
    MasterForkliftShowComponent.prototype.actionClicked = function (event) {
        console.log('action', event.action);
        console.log('event', event.event);
    };
    MasterForkliftShowComponent.prototype.sendBrand = function () {
        this.submitted = true;
    };
    MasterForkliftShowComponent.prototype.toggleCalendar = function () {
    ...
    MasterForkliftShowComponent.prototype.onChangeGenerateAlarms = function (check) {
        this.generateAlarms = check;
        console.log(check);
    };
    MasterForkliftShowComponent.prototype.onChangeActive = function (check) {
        this.active = check;
        console.log(check);
    };
    MasterForkliftShowComponent.prototype.loadingData = function () {
        var _this = this;
    ...
    MasterForkliftShowComponent.prototype.initialForklift = function () {
        var _this = this;
    ...
    MasterForkliftShowComponent.prototype.getCustomerOffice = function () {
        var _this = this;
    ...
    MasterForkliftShowComponent.prototype.change = function (value) {
        this.datesSelected = value;
    };
    MasterForkliftShowComponent.prototype.getCustomerModel = function () {
        var _this = this;
        console.log(this.selectedBusinessId);
    ...
    MasterForkliftShowComponent.prototype.preview = function (files) {
        var _this = this;
        console.log(files);
        if (files.length === 0) {
    ...
    MasterForkliftShowComponent.prototype.selectFile = function (event) {
        this.selectedFiles = event.target.files;
        console.log(this.selectedFiles);
    };
    MasterForkliftShowComponent.prototype.sendUpdateForklift = function () {
        var _this = this;
    ...
    MasterForkliftShowComponent.prototype.sendRoutinesForklift = function (idForlift) {
    ...
    MasterForkliftShowComponent.prototype.onChangeAlarm = function (check) {
        this.switchAlarm = check;
        console.log(check);
    };
    MasterForkliftShowComponent.prototype.onChangeStatus = function (check) {
        this.switchStatus = check;
        console.log(check);
    };
    MasterForkliftShowComponent.prototype.onSelectFile = function (event) {
        var _this = this;
    ...
    MasterForkliftShowComponent.prototype.ngOnInit = function () {
    };
    MasterForkliftShowComponent.prototype.selectToday = function () {
        this.modelPopup = { year: now.getFullYear(), month: now.getMonth() + 1, day: now.getDate() };
    };
    MasterForkliftShowComponent.prototype.deleteAllImagesForlift = function (idForklift) {
    ...
    MasterForkliftShowComponent.prototype.deleteAllRoutinesForlift = function (idForklift) {
    ...
    MasterForkliftShowComponent.prototype.onDateChange = function (date) {
        console.log(date);
    ...
    MasterForkliftShowComponent.prototype.deleteImage = function (i) {
    ...
    MasterForkliftShowComponent.prototype.hasJobs = function (date) {
    ...
    MasterForkliftShowComponent.prototype.upload = function (idForklift) {
        var _this = this;
        var i = 0;
        for (var _i = 0, _a = this.selectedFiles; _i < _a.length; _i++) {
            ...
            if (result === -1) {
                ...
                this.workService.storeImageForklift(idForklift, this.urls[0]).then(function (data) {
                    var resp = data;
                    console.log(data);
                    // swal.close();
                    console.log(resp);
        ...
        if (this.selectedFiles.length <= 0) {
            for (var _b = 0, _c = this.urls; _b < _c.length; _b++) {
                var url = _c[_b];
    ...
    MasterForkliftShowComponent.prototype.onChangeColorHex8 = function (color) {
        return this.cpService.outputFormat(this.cpService.stringToHsva(color, true), 'rgba', null);
    };
    MasterForkliftShowComponent.prototype.goAdminForklifts = function () {
        this.router.navigateByUrl('master/forkliftShow');
    };
    Object.defineProperty(MasterForkliftShowComponent.prototype, "checkForm", {
        get: function () { return this.myForm.controls; },
        enumerable: true,
        configurable: true
    });
    MasterForkliftShowComponent = MasterForkliftShowComponent_1 = __decorate([
        core_1.Component({
            ...
            providers: [I18n, { provide: ng_bootstrap_1.NgbDatepickerI18n, useClass: MasterForkliftShowComponent_1 }]
        }),
    ...
    return MasterForkliftShowComponent;
    var MasterForkliftShowComponent_1;
}(ng_bootstrap_1.NgbDatepickerI18n));
exports.MasterForkliftShowComponent = MasterForkliftShowComponent;
//# sourceMappingURL=master-forklift-show.component.js.map