...
var MasterBrandComponent = /** @class */ (function () {
    function MasterBrandComponent(restService, router) {
        /*  swal({
    ...
    MasterBrandComponent.prototype.loadingData = function () {
        var _this = this;
    ...
    MasterBrandComponent.prototype.updateFilter = function (event) {
    ...
    MasterBrandComponent.prototype.updateFilterActiveInactive = function (active) {
        var val = active;
        // filter our data
    ...
    MasterBrandComponent.prototype.onChangeCreate = function (check) {
        this.change = check;
        console.log(check);
    };
    MasterBrandComponent.prototype.onChangeUpdate = function (check) {
        this.switchUpdate = check;
        this.enabledUpdated = check;
        console.log(check);
    };
    MasterBrandComponent.prototype.onChangeActive = function (d) {
        var indice;
    ...
    MasterBrandComponent.prototype.onChangeInactive = function (d) {
        var indice;
    ...
    MasterBrandComponent.prototype.updateBrand = function (brand) {
        console.log(brand);
    ...
    MasterBrandComponent.prototype.sendBrand = function () {
        var _this = this;
    ...
    MasterBrandComponent.prototype.sendUpdateBrand = function () {
        var _this = this;
    ...
    Object.defineProperty(MasterBrandComponent.prototype, "checkForm", {
        get: function () { return this.myForm.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MasterBrandComponent.prototype, "checkFormUpdate", {
        get: function () { return this.myFormUpdate.controls; },
        enumerable: true,
        configurable: true
    });
    MasterBrandComponent.prototype.deleteBrand = function (brand) {
        var _this = this;
        sweetalert2_1.default({
    ...
    MasterBrandComponent.prototype.ngOnInit = function () {
    };
    MasterBrandComponent.prototype.blockAgents = function (vadr) {
        console.log(vadr);
    };
    MasterBrandComponent = __decorate([
        core_1.Component({
    ...
    return MasterBrandComponent;
}());
exports.MasterBrandComponent = MasterBrandComponent;
//# sourceMappingURL=master-brand.component.js.map