...
var MasterMachineComponent = /** @class */ (function () {
    function MasterMachineComponent(restService, router) {
        /*  swal({
    ...
    MasterMachineComponent.prototype.loadingData = function () {
        var _this = this;
    ...
    MasterMachineComponent.prototype.updateFilter = function (event) {
    ...
    MasterMachineComponent.prototype.updateFilterActiveInactive = function (active) {
        var val = active;
        // filter our data
    ...
    MasterMachineComponent.prototype.onChangeCreate = function (check) {
        this.change = check;
        console.log(check);
    };
    MasterMachineComponent.prototype.onChangeUpdate = function (check) {
        this.switchUpdate = check;
        this.enabledUpdated = check;
        console.log(check);
    };
    MasterMachineComponent.prototype.onChangeActive = function (d) {
        var indice;
    ...
    MasterMachineComponent.prototype.onChangeInactive = function (d) {
        var indice;
    ...
    MasterMachineComponent.prototype.updateBrand = function (brand) {
        console.log(brand);
    ...
    MasterMachineComponent.prototype.sendBrand = function () {
        var _this = this;
        ...
        if (!this.myForm.invalid) {
            ...
            this.restService.createMachine(this.myForm.get('description').value.toUpperCase(), statusTemp).then(function (data) {
                var resp = data;
                console.log(resp);
    ...
    MasterMachineComponent.prototype.sendUpdateBrand = function () {
        var _this = this;
    ...
    Object.defineProperty(MasterMachineComponent.prototype, "checkForm", {
        get: function () { return this.myForm.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MasterMachineComponent.prototype, "checkFormUpdate", {
        get: function () { return this.myFormUpdate.controls; },
        enumerable: true,
        configurable: true
    });
    MasterMachineComponent.prototype.deleteBrand = function (brand) {
        var _this = this;
        sweetalert2_1.default({
            ...
            if (willDelete.value) {
                ...
                sweetalert2_1.default.showLoading();
                _this.restService.deleteMachine(Number(_this.elementDelete.id))
                    .then(function (data) {
                    sweetalert2_1.default.showLoading();
                    var resp = data;
                    console.log(resp);
    ...
    MasterMachineComponent.prototype.ngOnInit = function () {
    };
    MasterMachineComponent.prototype.blockAgents = function (vadr) {
        console.log(vadr);
    };
    MasterMachineComponent = __decorate([
        core_1.Component({
    ...
    return MasterMachineComponent;
}());
exports.MasterMachineComponent = MasterMachineComponent;
//# sourceMappingURL=master-machine.component.js.map