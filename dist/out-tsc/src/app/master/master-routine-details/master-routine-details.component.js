...
var MasterRoutineDetailsComponent = /** @class */ (function () {
    function MasterRoutineDetailsComponent(restService, router) {
        /*  swal({
    ...
    MasterRoutineDetailsComponent.prototype.loadingData = function () {
        var _this = this;
    ...
    MasterRoutineDetailsComponent.prototype.updateFilter = function (event) {
    ...
    MasterRoutineDetailsComponent.prototype.updateFilterActiveInactive = function (active) {
        var val = active;
        // filter our data
    ...
    MasterRoutineDetailsComponent.prototype.onChangeCreate = function (check) {
        this.change = check;
        console.log(check);
    };
    MasterRoutineDetailsComponent.prototype.onChangeUpdate = function (check) {
        this.switchUpdate = check;
        this.enabledUpdated = check;
        console.log(check);
    };
    MasterRoutineDetailsComponent.prototype.onChangeActive = function (d) {
        var indice;
    ...
    MasterRoutineDetailsComponent.prototype.onChangeInactive = function (d) {
        var indice;
    ...
    MasterRoutineDetailsComponent.prototype.updateBrand = function (brand) {
        console.log(brand);
    ...
    MasterRoutineDetailsComponent.prototype.sendBrand = function () {
        var _this = this;
    ...
    MasterRoutineDetailsComponent.prototype.sendUpdateBrand = function () {
        var _this = this;
    ...
    Object.defineProperty(MasterRoutineDetailsComponent.prototype, "checkForm", {
        get: function () { return this.myForm.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MasterRoutineDetailsComponent.prototype, "checkFormUpdate", {
        get: function () { return this.myFormUpdate.controls; },
        enumerable: true,
        configurable: true
    });
    MasterRoutineDetailsComponent.prototype.deleteBrand = function (brand) {
        var _this = this;
        sweetalert2_1.default({
    ...
    MasterRoutineDetailsComponent.prototype.ngOnInit = function () {
    };
    MasterRoutineDetailsComponent.prototype.blockAgents = function (vadr) {
        console.log(vadr);
    };
    MasterRoutineDetailsComponent = __decorate([
        core_1.Component({
    ...
    return MasterRoutineDetailsComponent;
}());
exports.MasterRoutineDetailsComponent = MasterRoutineDetailsComponent;
//# sourceMappingURL=master-routine-details.component.js.map