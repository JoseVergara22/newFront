...
export class MasterUpdateSettlementCustomerComponent extends NgbDatepickerI18n  {
  ...
  selectedBranchPart:any = 0;
  selectedBranchWorkforce:any = 0;
  selectedBranchCustomer:any = 0;
  selectedForkliftPart:any = 0;
  selectedForkliftWorkforce:any = 0;
  selectedForkliftCustomer:any = 0;
...
storeMaintenance(){
  ...
  checkUncheckAll() {
    ...
    for (let i = 0; i < this.dataMaintenances.length; i++) {
      ...
      this.dataMaintenances[i].active = this.checkAll;
    }
  }
  ...
  checkUncheckAllPart() {
    ...
    for (let i = 0; i < this.dataMaintenances.length; i++) {
      console.log('lo encontre' + i);
      this.dataMaintenances[i].part = false;
    }

      this.countPartMaintenance = 0;

  }

  checkUncheckAllWorkforce() {

    this.checkAllWorkforce = false;
    for (let i = 0; i < this.dataMaintenances.length; i++) {
      console.log('lo encontre' + i);
      this.dataMaintenances[i].workforce = false;
    }

      this.countWorkforceMaintenance = 0;
