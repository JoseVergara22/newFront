    ...
    getEstimateId(row: any){
      ...
      this.estimateService.getEstimateId(row.id).then(data => {
        ...
        if(resp.success==true){
          ...
          console.log(this.estimateCurrent.forklift_text);
          ...
          console.log(this.estimateCurrent.observation);
...
loadPdfSendEmail(){
  ...
  //Este total se debe remplazar por el subtotal_parts que se encuentra en la tabla de settlement
    ...
    console.log('total'); 
    console.log(this.rowsItemspartsSettlement[i].subtotal_decimal); 
  ...
  let value=  Number(this.rowsItemsWorkforceSettlement[i].total);
    ...
    console.log('total'); 
    console.log(this.rowsItemsWorkforceSettlement[i].sub_cost_center); 
  ...
  // getEstimatePrice(fromdate:string, to_date:string){
  //   // Llenar información de cliente  
  //   console.log('entro filtro')
  //   this.resumenesService.getEstimatePriceFilter(this.forkliftId,fromdate,to_date).then(data => {
  //     const resp: any = data;
  //     console.log(data);
  //     swal.close();
  //     this.priceEs=resp.data;
  //     const subHours = this.priceEs.map(res => res.subtotal_hours);
  //     const subParts = this.priceEs.map(res => res.subtotal_parts);

  //     const dates = [];

  //     this.priceEs.forEach(result => {
  //       dates.push(result.create_at);
  ...
  //       });
  //     });
  //     console.log(this.chartEs);
  //   }).catch(error => {
  //     console.log(error);
  //     swal({
  //       title:'Error',
  //       text: 'Ha ocurrido un error al cargar la grafica de cotzaciones',
  //       type: 'error'
  //      });
  //   });
  // }
  ...
  //   this.resumenesService.showPriceEstimate(this.forkliftId).then(data => {
  //     console.log('Datos de partes');
  //     console.log(data);
  //     const resp: any = data;
  //     this.priceEs=resp.data;
  ...
  //     swal({
  //       title:'Error',
  //       text: 'Ha ocurrido un error al cargar la grafica de cotizaciones',
  //       type: 'error'
  //      });
  //   });
