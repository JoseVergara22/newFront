...
@Component({
  ...
  styleUrls: ['./master-different-times-assignation.component.scss',
  '../../../assets/icon/icofont/css/icofont.scss'],
  providers: [I18n, {provide: NgbDatepickerI18n, useClass: MasterDifferentTimesAssignationComponent}]
})
export class MasterDifferentTimesAssignationComponent extends NgbDatepickerI18n {
  ...
  checkUncheckAllStatus(event:any){
    ...
    // if(cont >=1){      
      ...
      console.log('.---------->'+params);
      this.reportService.showFilterDurationTimes(params).then(data => {
        const resp: any = data;
        ...
        this.exportAsExcelFile(this.dataExcels,'Informe Diferencia de Tiempo de Mantenimiento Correctivo'+ fromD + ' - ' + untilD);
        swal.close();
