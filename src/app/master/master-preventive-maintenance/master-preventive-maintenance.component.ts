...
export class MasterPreventiveMaintenanceComponent extends NgbDatepickerI18n {
  ...
  routineUpdateSelecteds: Array <itemSelectInterface> = [];
  routineUpdateSelected: itemSelectInterface;

  technicianUpdateSelecteds: Array <itemSelectInterface> = [];
  technicianUpdateSelected: itemSelectInterface;
    ...
    let params;
     ...
     console.log('entro');
      ...
      for (let item of this.technicianSelecteds) {
        ...
        console.log(this.forklift);
        this.resumenesService.updatePreventive(this.selectedForkliftId.id,this.preventiveList,this.technicianList,params).then(data => {
          const resp: any = data;
          console.log(data);
          if (resp.success == false) {
            swal({
