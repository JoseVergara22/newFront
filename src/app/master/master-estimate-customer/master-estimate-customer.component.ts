...
finalOperation(country:number){
  ...
  if(this.conditionValidation==3){
    ...
    if(country==4){
      drivingCost=this.unitCost*Number(this.managementVariables)+this.unitCost*0.10;
    }else{
  ...
  if(this.conditionValidation==2){
     operationFreight = Number(this.freightGeneral)*1;
  }else{
  ...
  let margin=0.17; // llamar api para cada usuario y configurar clientes que no existan
