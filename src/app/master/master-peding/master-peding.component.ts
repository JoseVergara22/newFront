...
@Component({
  ...
  styleUrls: ['./master-peding.component.scss',
  '../../../assets/icon/icofont/css/icofont.scss'],
  providers: [I18n, {provide: NgbDatepickerI18n, useClass: MasterPedingComponent}]
})
...
export class MasterPedingComponent extends NgbDatepickerI18n {
  ...
  constructor(private restService: RestService, public formatter: NgbDateParserFormatter, 
    private _i18n: I18n, private router: Router, private resumenesService: ResumenesService,
     private pendingService: PendingService,    private forkliftService: ForkliftService) {
    super();
  ...
  getCustomerRegionals() {
   ...
   getForkliftPendingGeneralMain(){
    ...
    this.resumenesService.getForkliftPendingGeneral(49).then(data => {
      const resp: any = data;
      console.log(data);
      swal.close();
...
createPreventive(){
  ...
  if(this.status==1){
    ...
    console.log(this.newStatus);
          ...
          this.pendingService.updatePreventivePending(this.currentPending.pending,this.consecutive,this.observation,this.newStatus).then(data => {
            const resp: any = data;
            console.log(data);
...
createCorrective(){
  ...
  if(this.status==1){
    ...
    console.log(this.newStatus);
          ...
          console.log(this.forklift);
          this.pendingService.updateCorrectivePending(this.currentPending.pending,this.consecutive,this.observation,this.newStatus).then(data => {
            const resp: any = data;
            console.log(data);
            if (resp.success == false) {
              swal({
...
createChecklist(){
  ...
  if(this.status==1){
    ...
    console.log(this.newStatus);
          ...
          console.log(this.forklift);
          this.pendingService.updateChecklistPending(this.currentPending.pending,this.consecutive,this.observation,this.newStatus).then(data => {
            const resp: any = data;
            console.log(data);
            if (resp.success == false) {
              swal({
...
createPlatform(){
  ...
  if(this.status==1){
    ...
    console.log(this.newStatus);
          ...
          console.log(this.forklift);
          this.pendingService.updatePlatformpending(this.currentPending.pending,this.consecutive,this.observation,this.newStatus).then(data => {
            const resp: any = data;
            console.log(data);
            if (resp.success == false) {
              swal({
...
createStevedore(){
  ...
  if(this.status==1){
    ...
    console.log(this.newStatus);
          ...
          console.log(this.forklift);
          this.pendingService.updateStevedorePending(this.currentPending.pending,this.consecutive,this.observation,this.newStatus).then(data => {
            const resp: any = data;
            console.log(data);
            if (resp.success == false) {
              swal({
...
createBattery(){
  ...
  if(this.status==1){
    ...
    console.log(this.newStatus);
          ...
          console.log(this.forklift);
          this.pendingService.updateBatteryPending(this.currentPending.pending,this.consecutive,this.observation,this.newStatus).then(data => {
            const resp: any = data;
            console.log(data);
            if (resp.success == false) {
              swal({
